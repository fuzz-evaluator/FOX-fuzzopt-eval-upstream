...
cp ./build/bin/$BIN_NAME ../binaries_noasan/aflpp_build
...
cmake -S . -DBUILD_SHARED_LIBS=OFF -B build -DCMAKE_BUILD_TYPE=Release
cmake --build build -j$(nproc)
cp ./build/bin/$BIN_NAME ../binaries_noasan/cmplog_build
...
cmake -S . -DBUILD_SHARED_LIBS=OFF -B build -DCMAKE_BUILD_TYPE=Release
cmake --build build -j$(nproc)
cp ./build/bin/$BIN_NAME ../binaries_noasan/optfuzz_build
